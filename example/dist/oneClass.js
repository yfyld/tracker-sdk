...
(function (global, factory) {
  ( false ? 'undefined' : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports) :  true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				...
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : (global = global || self, factory(global.tracker = {}));
  ...
  ***************************************************************************** */
  ...
  function getRawTag$1(value) {
    var isOwn = hasOwnProperty$1.call(value, symToStringTag$2),
  ...
  typedArrayTags[argsTag$1] = typedArrayTags[arrayTag] = typedArrayTags[arrayBufferTag] = typedArrayTags[boolTag] = typedArrayTags[dataViewTag] = typedArrayTags[dateTag] = typedArrayTags[errorTag] = typedArrayTags[funcTag$2] = typedArrayTags[mapTag] = typedArrayTags[numberTag] = typedArrayTags[objectTag] = typedArrayTags[regexpTag] = typedArrayTags[setTag] = typedArrayTags[stringTag] = typedArrayTags[weakMapTag] = false;
  ...
  cloneableTags[errorTag$1] = cloneableTags[funcTag$3] = cloneableTags[weakMapTag$2] = false;
  ...
  //# sourceMappingURL=trackerInfo.js.map
  ...
  if (scriptDom) {
    ...
    if (newConfig) {
      config = _assign({}, config, JSON.parse(newConfig));
    }
  }
  function getConfig() {
    return config;
  ...
  function baseIsArguments$1(value) {
    return isObjectLike$1(value) && baseGetTag(value) == argsTag$4;
  }
  ...
  var isArguments$1 = baseIsArguments$1(function () {
    ...
    return isObjectLike$1(value) && hasOwnProperty$j.call(value, 'callee') && !propertyIsEnumerable$3.call(value, 'callee');
  };
  ...
  typedArrayTags$1[argsTag$5] = typedArrayTags$1[arrayTag$3] = typedArrayTags$1[arrayBufferTag$5] = typedArrayTags$1[boolTag$5] = typedArrayTags$1[dataViewTag$6] = typedArrayTags$1[dateTag$5] = typedArrayTags$1[errorTag$5] = typedArrayTags$1[funcTag$4] = typedArrayTags$1[mapTag$7] = typedArrayTags$1[numberTag$5] = typedArrayTags$1[objectTag$5] = typedArrayTags$1[regexpTag$5] = typedArrayTags$1[setTag$7] = typedArrayTags$1[stringTag$5] = typedArrayTags$1[weakMapTag$4] = false;
  ...
  /* Built-in method references that are verified to be native. */
  var DataView$1 = getNative$1(root, 'DataView');

  /* Built-in method references that are verified to be native. */
  var Promise$2 = getNative$1(root, 'Promise');

  /* Built-in method references that are verified to be native. */
  var Set$1 = getNative$1(root, 'Set');
  ...
  // Fallback for data views, maps, sets, and weak maps in IE 11 and promises in Node.js < 6.
  if (DataView$1 && getTag$1(new DataView$1(new ArrayBuffer(1))) != dataViewTag$7 || Map$1 && getTag$1(new Map$1()) != mapTag$8 || Promise$2 && getTag$1(Promise$2.resolve()) != promiseTag$1 || Set$1 && getTag$1(new Set$1()) != setTag$8 || WeakMap$1 && getTag$1(new WeakMap$1()) != weakMapTag$5) {
  ...
  function baseIsEqualDeep$1(object, other, bitmask, customizer, equalFunc, stack) {
    var objIsArr = isArray$1(object),
        ...
        objTag = objIsArr ? arrayTag$4 : getTag$2(object),
        othTag = othIsArr ? arrayTag$4 : getTag$2(other);
  ...
  function setUserInfo(info) {
    ...
    userInfo = _assign({}, userInfo, { identify: getCookie(config.identify || TRACKER_IDENTIFY) }, info);
  }
  ...
  var PageTimeTracker = /** @class */function () {
    ...
    PageTimeTracker.prototype.end = function () {
      this.endTime = Date.now();
      var data = _assign({ actionType: ACTION_TYPE.PAGE, startTime: this.startTime, endTime: this.endTime, durationTime: this.endTime - this.startTime - this.totalInvalidTime }, this.info);
    ...
    PageTimeTracker.prototype.change = function () {
      ...
      var data = _assign({ actionType: ACTION_TYPE.PAGE, startTime: this.startTime, endTime: this.endTime, trackId: this.info.trackId, durationTime: this.endTime - this.startTime - this.totalInvalidTime }, this.info);
  ...
  var instance$1 = PerformanceTracker.getInstance();
  ...
  var vissense = createCommonjsModule(function (module, exports) {
    ...
    !function (root, name, factory) {
      var withWindow = function withWindow(win) {
      ...
      function isArray(value) {
        return value && "object" == (typeof value === 'undefined' ? 'undefined' : _typeof(value)) && "number" == typeof value.length && "[object Array]" === Object.prototype.toString.call(value) || !1;
      }
        ...
        return PubSub.prototype.on = function (topic, callback) {
          ...
          var applyCallback = function applyCallback(args) {
            return callback.apply(undefined$1, args || []);
              ...
              unregister = function unregister(listener, array, topic) {
            return function () {
              var index = array.indexOf(listener);
              return index > -1 ? (array.splice(index, 1), !0) : !1;
            };
          };
          return topic === this._config.anyTopicName ? (this._onAnyCache.push(listener), unregister(listener, this._onAnyCache)) : (this._cache[topic] || (this._cache[topic] = []), this._cache[topic].push(listener), unregister(listener, this._cache[topic]));
        }, PubSub.prototype.publish = function (topic, args) {
          var listeners = (this._cache[topic] || []).concat(topic === this._config.anyTopicName ? [] : this._onAnyCache),
              enableAsync = !!this._config.async,
              syncOrAsyncPublish = enableAsync ? async(syncFireListeners) : function (listeners, args) {
      ...
      }, VisMon.Strategy.CompositeStrategy.prototype = Object.create(VisMon.Strategy.prototype), VisMon.Strategy.CompositeStrategy.prototype.init = function (monitor) {
  ...
  var createInnerMonitor = function createInnerMonitor(outerMonitor, callback, config) {
    ...
    return VisSense.VisMon.Builder(outerMonitor.visobj()).strategy(new VisSense.VisMon.Strategy.PollingStrategy({ interval: interval })).on('update', function (monitor) {
  ...
  var onPercentageTimeTestPassed = function onPercentageTimeTestPassed(visobj, callback, config) {
  ...
  var ActionTracker = /** @class */function () {
    ...
    ActionTracker.prototype.trackPage = function (info) {
      ...
      var data = _assign({ actionType: ACTION_TYPE.PAGE }, info);
      instance.info = data;
      var config = getConfig();
      if (!config.pageTime) {
        send(data);
    ...
    ActionTracker.prototype.trackEvent = function (info) {
      ...
      var data = _assign({ actionType: ACTION_TYPE.EVENT, eventName: "CLICK" }, info);
      send(data);
    };
    ActionTracker.prototype.trackView = function (dom, info) {
      if (info === void 0) {
        info = {};
      }
      var data = _assign({ actionType: ACTION_TYPE.VIEW, domId: dom.id, domClass: dom.className, domTag: dom.tagName, domContent: dom.textContent.substr(0, 20), domPath: getDomPath(dom) }, info);
    ...
    ActionTracker.prototype.trackLink = function (linkDom, info) {
      ...
      var trackInfo = _assign({ href: linkDom.href || "", domId: linkDom.id, domClass: linkDom.className, domTag: linkDom.tagName, domContent: linkDom.textContent.substr(0, 20), domPath: getDomPath(linkDom) }, info);
    ...
    ActionTracker.prototype.trackDom = function (dom, info) {
      ...
      if (track && track.search(/^\{[\S\s]*\}$/) >= 0) {
        trackInfo = _assign({}, trackInfo, JSON.parse(track));
      } else {
        trackInfo.trackId = track || "";
      }
      if (info) {
        trackInfo = _assign({}, trackInfo, info);
      }
      this.trackEvent(trackInfo);
    };
    ActionTracker.prototype.trackPerformance = function () {
      var _this = this;
      var info = instance$1.getRenderTiming();
      if (info.loadPage <= 0) {
        setTimeout(function () {
      ...
      var data = _assign({ actionType: ACTION_TYPE.PERFORMANCE }, info);
      send(data);
    };
    ActionTracker.instance = null;
    return ActionTracker;
  }();
  var instance$2 = ActionTracker.getInstance();
  ...
  var track = function track(partical, key, descriptor) {
    ...
    } else if ((typeof partical === 'undefined' ? 'undefined' : _typeof(partical)) === 'object') {
      return function (target, key, descriptor) {
        var oldValue = descriptor.value;
        descriptor.value = function () {
          var data = _assign({}, partical);
          instance$2.trackEvent(data);
  ...
  var before = curryN(2, function (trackFn, fn) {
    return function () {
      var args = [];
      for (var _i = 0; _i < arguments.length; _i++) {
        args[_i] = arguments[_i];
      ...
      if (isFunction(trackFn)) {
        try {
          ...
          if ((typeof result === 'undefined' ? 'undefined' : _typeof(result)) === 'object') {
            instance$2.track(result);
          }
        } catch (e) {
          console.error(e);
        }
      } else if ((typeof trackFn === 'undefined' ? 'undefined' : _typeof(trackFn)) === 'object') {
        instance$2.track(trackFn);
      } else if (typeof trackFn === 'string') {
        var data = {
          trackId: trackFn
        };
        instance$2.track(data);
      }
      return fn.apply(this, args);
    };
  });
  ...
  var generate = function generate(type) {
    var watch = [];
    var track = {
      bind: function bind(el, binding, vnode) {
        ...
        if (type === 'PAGE') {
          instance$2.trackPage(info);
        } else {
          instance$2.trackView(el, info);
        }
      },
  ...
  function handleEvent(e) {
    ...
    instance$2.trackDom(this, this._trackerInfo);
  }
  ...
  var install = function install(conf) {
    ...
    if (config.autoTrakerPage) {
      instance$2.trackPage();
    }
    if (config.performance) {
      instance$2.trackPerformance();
    }
    if (config.pageTime) {
      instance.start();
    }
    ...
    document.addEventListener('click', function (e) {
      ...
      var _loop_1 = function _loop_1(target) {
  ...
  try {
    Object({"WEBPACK_ENV":development}).NODE_ENV;
  } catch (e) {
  ...
  exports.actionTracker = instance$2;
  exports.after = after;
