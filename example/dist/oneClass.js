(function (factory) {
  ...
  (function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var SAFETY_KEY = ['custom', 'actionType', 'eventName', 'pageId', 'domId', 'domClass', 'domHref', 'domName', 'domTag', 'domContent', 'domPath', 'trackId', 'referrerId', 'score', 'startTime', 'endTime', 'durationTime', 'channel', 'netType']; //default config
    ...
    var _has_1 = _has; // Based on https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object/is
    ...
    function login(info) {
      ...
      setUserInfo(__assign(__assign({}, info), {
        isLogin: true
      }));
    }
    ...
    var setPageInfo = function (info) {
      pageInfo = __assign(__assign(__assign({}, pageInfo), info), {
        url: location.origin,
        host: location.host,
        path: location.pathname,
        hash: location.hash,
    ...
    function http(data, isAjax, isSendBeacon) {
      ...
      return new Promise(function (resolve) {
        ...
        if (window.location.protocol === 'https:' && isSendBeacon && typeof window.navigator.sendBeacon === 'function' && typeof Blob === 'function') {
          var headers = {
    ...
    function sendAsync(data) {
      ...
      clearTimeout(timer); // 无参数或者大于10条发送发送
    ...
    function _wrapperData(data) {
      ...
      return __assign(__assign(__assign(__assign({
        items: data
      }, clientInfo()), libInfo), getUserInfo()), {
    ...
    function _generateData(data, config) {
      ...
      var result = __assign(__assign(__assign(__assign({}, newData), pageInfo), netInfo), {
        trackTime: Date.now(),
        id: uuid + '-' + index
    ...
    function () {
      function PageTimeTracker() {
        ...
        this.endTime = Date.now(); // invalidStartTime = Date.now();
      ...
      PageTimeTracker.prototype.start = function (data) {
        ...
        window.addEventListener('visibilitychange', function () {
          ...
          if (isHidden) {
            ...
            _this.info = _this.backInfo; // todo 处理pageInfo
          ...
          return PubSub.prototype.on = function (topic, callback) {
            ...
            var applyCallback = function (args) {
              return callback.apply(undefined$1, args || []);
                ...
                unregister = function (listener, array, topic) {
              return function () {
    ...
    var set = /*#__PURE__*/_curry3_1(function set(lens, v, x) {
    ...
    var keys$1 = typeof Object.keys === 'function' && !hasArgsEnumBug$1 ? /*#__PURE__*/_curry1$1(function keys(obj) {
      return Object(obj) !== obj ? [] : Object.keys(obj);
    ...
    var assoc = /*#__PURE__*/_curry3$1(function assoc(prop, val, obj) {
      var result = {};
    ...
    var lens = /*#__PURE__*/_curry2$1(function lens(getter, setter) {
    ...
    var lensProp = /*#__PURE__*/_curry1$1(function lensProp(k) {
    ...
    var generate = function (type) {
      ...
      var track = {
        bind: function (el, binding, vnode) {
          ...
          if (typeof binding.value === 'object') {
            info = binding.value; //if (value.pageURL) args.push(value.pageURL)
    ...
    var install = function (conf) {
      ...
      var config = getConfig(); //注入history事件

      hijackHistoryEvent(); //自动埋页面
      ...
      document.addEventListener('click', function (e) {
        ...
        for (var _i = 0, _a = e.path; _i < _a.length; _i++) {
          ...
          if (target.getAttribute('data-track') || config.autoTrackClick && (target.tagName === 'A' || target.tagName === 'BUTTON' || target.tagName === 'INPUT') && !target._isWatchTrack) {
  ...
  unwrapExports(telescope_min);
  var telescope_min_1 = telescope_min.before;
  var telescope_min_2 = telescope_min.after;
  var telescope_min_3 = telescope_min.tracker;
  var telescope_min_4 = telescope_min.trackView;
  var telescope_min_5 = telescope_min.trackEvent;
  var telescope_min_6 = telescope_min.trackPage;
  var telescope_min_7 = telescope_min.install;
  var telescope_min_8 = telescope_min.pageTimeTracker;
  var telescope_min_9 = telescope_min.actionTracker;
  var telescope_min_10 = telescope_min.setConfig;
  var telescope_min_11 = telescope_min.getConfig;
  var telescope_min_12 = telescope_min.sendAsync;
  var telescope_min_13 = telescope_min.send;
  var telescope_min_14 = telescope_min.sendSync;
  var telescope_min_15 = telescope_min.login;
  var telescope_min_16 = telescope_min.logout;

  var _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _class;
  var OneClass = (_dec = telescope_min_3('fn1'), _dec2 = telescope_min_3({
    trackId: 'fn2Id'
  }), _dec3 = telescope_min_3(function () {
    console.log(this);
    return {
      trackId: 'fn3Id'
    };
  }), _dec4 = telescope_min_3(telescope_min_2(function () {
    console.log(this);
    console.log('fn4 after');
    return {
      trackId: 'fn4Id'
    };
  })), _dec5 = telescope_min_3(telescope_min_1(function () {
    console.log('fn5 before', this);
    return {
      trackId: 'fn5Id'
    };
  })), _dec6 = telescope_min_3(telescope_min_2(function () {
    console.log('fn6 after');
    return {
      trackId: 'fn6Id'
    };
  })), _dec7 = telescope_min_3(telescope_min_2('fn7Id')), _dec8 = telescope_min_3(telescope_min_2('fn8Id')), (_class = /*#__PURE__*/function () {
    function OneClass() {
