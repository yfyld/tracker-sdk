...
var demo = (_dec = (0, _tracker.track)("iiidd"), _dec2 = (0, _tracker.track)(function () {
  return { aaaa: 1 };
  ...
  console.log(99991);
  return { asdfasdf: 111 };
})), _dec6 = (0, _tracker.track)((0, _tracker.after)("cccccc")), (_class = function () {
  function demo() {
  ...
  return demo;
}(), (_applyDecoratedDescriptor(_class.prototype, "aaa", [_tracker.track], Object.getOwnPropertyDescriptor(_class.prototype, "aaa"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "ccc", [_dec], Object.getOwnPropertyDescriptor(_class.prototype, "ccc"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "fff", [_dec2], Object.getOwnPropertyDescriptor(_class.prototype, "fff"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "a1", [_dec3], Object.getOwnPropertyDescriptor(_class.prototype, "a1"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "a2", [_dec4], Object.getOwnPropertyDescriptor(_class.prototype, "a2"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "a3", [_dec5], Object.getOwnPropertyDescriptor(_class.prototype, "a3"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "a4", [_dec6], Object.getOwnPropertyDescriptor(_class.prototype, "a4"), _class.prototype)), _class));
exports.demo = demo;
...
(function (global, factory) {
	( false ? 'undefined' : _typeof2(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports) :  true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				...
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : factory(global.tracker = {});
  ...
  */
	function isSymbol(value) {
		return (typeof value === 'undefined' ? 'undefined' : _typeof2(value)) == 'symbol' || isObjectLike_1(value) && _baseGetTag(value) == symbolTag;
	}
  ...
  */
	...
	var func = convert_1('isFunction', isFunction_1, _falseOptions);

	func.placeholder = placeholder;
	var isFunction$1 = func;

	var func$1 = convert_1('curry', curry_1);

	func$1.placeholder = placeholder;

	var func$2 = convert_1('curryN', curry_1);
  ...
  */
	...
	var func$3 = convert_1('attempt', attempt_1);

	func$3.placeholder = placeholder;

	var func$4 = convert_1('isError', isError_1, _falseOptions);
  ...
  */
	...
	var func$7 = convert_1('reduce', reduce_1);

	func$7.placeholder = placeholder;

	var func$8 = convert_1('memoize', memoize_1);
  ...
  */
	...
	var func$9 = convert_1('mapValues', mapValues_1);
  ...
  */
	...
	var func$a = convert_1('set', set_1);
  ...
  */
	...
	var func$b = convert_1('isEqual', isEqual_1);

	func$b.placeholder = placeholder;
	var isEqual$1 = func$b;
	...
	function notChanged(binding) {
		if (binding.oldValue !== undefined) {
			if (_typeof(binding.value) === 'object') {
				return isEqual$1(binding.value, binding.oldValue);
			} else {
  ...
  */
	...
	var config = {
		...
		//自动埋点a,button,input
		autoInstall: true //script tracker-key  config
	...
	if (scriptDom) {
		...
		if (newConfig) {
			config = _objectSpread({}, config, JSON.parse(newConfig));
		}
	}
	...
	function setConfig(data) {
		config = _objectSpread({}, config, data);
	}
	...
	function () {
		...
		_createClass(ActionTracker, [{
			...
			key: "trackByDomAttr",
			value: function trackByDomAttr(dom) {
				var info = {
					domId: dom.id,
				...
				if (track && track.search(/^\{[\S\s]*\}$/) >= 0) {
					info = _objectSpread({}, info, JSON.parse(track));
				} else {
					info.trackId = track || "";
				}
	...
	var track = function track(partical, key, descriptor) {
		if (isFunction$1(partical)) {
			return function (target, key, descriptor) {
				...
				return set$2('value', value, descriptor);
			};
		} else if (_typeof(partical) === 'object' && typeof partical.constructor === 'function') {
		...
		} else if (_typeof(partical) === 'object') {
			return function (target, key, descriptor) {
				var oldValue = descriptor.value;
	...
	function () {
		function PageTimeTracker() {
			...
			_defineProperty(this, "endTime", Date.now());

			_defineProperty(this, "pageTimes", []);

			_defineProperty(this, "invalidStartTime", Date.now());

			_defineProperty(this, "invalidEndTime", Date.now());
	...
	var trackPageview = {
		bind: function bind(el, binding) {
			...
			actionTracker.trackPageview.apply(actionTracker, _toConsumableArray(args));
		},
	...
	function trackEvent(el, binding) {
		...
		events.forEach(function (event) {
			el.addEventListener(event, function () {
				return actionTracker.track.apply(actionTracker, _toConsumableArray(args));
			}, false);
		});
	}
	...
	exports.after = after;
	exports.track = track;
	exports.trackView = trackPageview;
	...
	exports.sendStorageData = sendStorageData;
	exports.sendAsyncData = sendAsyncData;
	exports.send = send;
