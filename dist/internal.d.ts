...
export { before, after, tracker, vTrackView, vTrackEvent, vTrackPage, install, actionTracker, trackDom, trackPage, trackEvent, trackViewStart, trackView, trackViewEnd, trackLink, track, setConfig, getConfig, sendAsync, send, sendSync, login, logout };
