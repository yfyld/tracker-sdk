...
declare const trackDom: (dom: HTMLLinkElement | HTMLInputElement, info?: import("./types").ITrackerData) => void;
declare const trackPage: (info?: import("./types").ITrackerParam) => void;
declare const trackEvent: (info?: import("./types").ITrackerParam) => void;
declare const trackView: (dom: HTMLElement, info: import("./types").ITrackerParam, visSenseConfig?: import("./types").VisSenseConfig) => void;
declare const trackLink: (linkDom: HTMLLinkElement, info?: import("./types").ITrackerData) => void;
declare const track: (info?: import("./types").ITrackerData) => void;
