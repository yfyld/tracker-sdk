...
declare const trackViewStart: (dom: HTMLElement, info: import("./core/actionTracker").ITrackerViewParam, visSenseConfig?: import("./types").VisSenseConfig) => void;
...
export { before, after, tracker, vTrackView, vTrackEvent, vTrackPage, install, actionTracker, trackDom, trackPage, trackEvent, trackViewStart, trackViewEnd, trackLink, track, setConfig, getConfig, sendAsync, send, sendSync, login, logout };
