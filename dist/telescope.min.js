(function (global, factory) {
  ...
  ***************************************************************************** */
  ...
  var setPageInfo = function (info) {
      pageInfo = __assign(__assign(__assign({}, pageInfo), info), { url: location.href, host: location.host, path: location.pathname, hash: location.hash, title: document.title || '' });
      window.aaa = pageInfo;
  };
  ...
  function _wrapperData(data) {
      ...
      var config = getConfig();
      index++;
      return __assign(__assign(__assign(__assign({ customTime: Date.now(), items: data }, clientInfo()), libInfo), getUserInfo()), { version: config.version });
  }
  /**
   * 补充埋点信息
   * @param data
  ...
  var ActionTracker = /** @class */ (function () {
      ...
      ActionTracker.prototype.trackPage = function (info) {
          if (info === void 0) { info = {}; }
          var _a = getPageInfo(), pageId = _a.pageId, url = _a.url, referrerUrl = _a.referrerUrl;
  ...
  var install = function (conf) {
      ...
      document.addEventListener('click', function (e) {
          ...
          while (element && element.tagName && element.tagName.toUpperCase() !== 'HTML') {
              //是否有埋点属性
