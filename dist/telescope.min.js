(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var scriptDom = document.querySelector('script[track-token]');
    if (scriptDom) {
        var newConfig = Base64.decode(scriptDom.getAttribute('track-token') || '');
        if (newConfig) {
    ...
    function http(data, isAjax, isSendBeacon) {
        ...
        return new Promise(function (resolve) {
            ...
            var dataStr = data;
            var url = SERVER_URL + "?" + (config.trackToken ? "trackToken=" + config.trackToken + "&" : '') + (config.store ? "store=" + config.store + "&" : '') + "time=" + Date.now();
