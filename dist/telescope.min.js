(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    function login(info) {
        ...
        var deviceId = userInfo.deviceId || getCookie('TRACKER_IDENTIFY') || getCookie(config.deviceIdKey);
        if (!deviceId) {
            deviceId = getUUID();
    ...
    var DurationTime = /** @class */ (function () {
        ...
        DurationTime.prototype.generateLog = function (info) {
            var log = __assign(__assign({}, info), { actionType: 'DURATION', durationTime: Date.now() - info.startTime, trackTime: Date.now(), masterId: info.id, trackId: '', pageId: info.actionType === ACTION_TYPE.PAGE ? info.trackId : info.pageId, id: getUUID() });
            return log;
        };
    ...
    function _generateData(data, config) {
        ...
        if (data.actionType === 'EVENT') {
            localStorage.setItem('source_event_id', JSON.stringify({
                date: Date.now(),
                id: data.trackId,
                pageId: data.pageId
            }));
        ...
        if (result.actionType === ACTION_TYPE.VIEW && !data.debug) {
            var durationLogs = instance.end(data.trackId);
            if (durationLogs && durationLogs.length) ;
            instance.start(result);
        }
    ...
    var ActionTracker = /** @class */ (function () {
        ...
        ActionTracker.prototype.trackPage = function (info) {
            if (info === void 0) { info = {}; }
            var offlineUrl = getConfig().offlineUrl;
        ...
        ActionTracker.prototype._trackEvent = function (info, domInfo) {
            ...
            if (!data.trackId && !data.debug) {
                var code = hashCode((domInfo === null || domInfo === void 0 ? void 0 : domInfo.domId) + (domInfo === null || domInfo === void 0 ? void 0 : domInfo.domClass) + (domInfo === null || domInfo === void 0 ? void 0 : domInfo.domTag) + (domInfo === null || domInfo === void 0 ? void 0 : domInfo.domContent));
         ...
         */
        ActionTracker.prototype.trackViewStart = function (dom, info, visSenseConfig) {
        ...
        ActionTracker.prototype.trackViewEnd = function (trackId) {
            send({ trackId: trackId, actionType: ACTION_TYPE.VIEW });
        };
        /**
         *通用埋点入口 根据埋点类型调用
         *
    ...
    var install = function (conf) {
        ...
        function routeChange() {
            if (config.autoTrackPage) {
                ...
                setTimeout(function () {
                    var timeee = Math.abs(Date.now() - instance$1.record.pageTrackTime);
                    if (!instance$1.record.pageTrackTime || timeee > 1000) {
        ...
        var track = {
            bind: function (el, binding, vnode) {
                ...
                if (type === 'PAGE') {
                    ...
                    instance$1.trackViewStart(el, info);
                }
            },
