(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    //# sourceMappingURL=durationTime.js.map
    ...
    var ActionTracker = /** @class */ (function () {
        ...
        ActionTracker.prototype._trackEvent = function (info, domInfo) {
            ...
            if (!data.trackId && !data.debug) {
                var code = hashCode((domInfo === null || domInfo === void 0 ? void 0 : domInfo.domId) + (domInfo === null || domInfo === void 0 ? void 0 : domInfo.domClass) + (domInfo === null || domInfo === void 0 ? void 0 : domInfo.domTag));
         ...
         * @memberof ActionTracker
         */
        ActionTracker.prototype.trackLog = function (info, domInfo) {
            if (info === void 0) { info = {}; }
            var _a = getConfig(), offlineUrl = _a.offlineUrl, autoTrackPrefix = _a.autoTrackPrefix;
            var data = __assign({ debug: true, actionType: ACTION_TYPE.EVENT, eventName: 'CLICK' }, info);
            if (!data.trackId && !data.debug) {
                var code = hashCode((domInfo === null || domInfo === void 0 ? void 0 : domInfo.domId) + (domInfo === null || domInfo === void 0 ? void 0 : domInfo.domClass) + (domInfo === null || domInfo === void 0 ? void 0 : domInfo.domTag));
                data.trackId = autoTrackPrefix + "event-" + hashCode(getRealPath(window.location.href, offlineUrl)) + "-" + code;
                data.isAutoTrack = true;
