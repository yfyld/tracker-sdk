(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var DurationTime = /** @class */ (function () {
        ...
        DurationTime.prototype.beat = function () {
            var logs = [];
            for (var trackId in this.timeMap) {
     ...
     * @param isAjax
     */
    function sendToServer(data, isAjax) {
        if (!data.length) {
            return;
        }
    ...
    var install = function (conf) {
        ...
        var onLeave = (function () {
            ...
            return function () {
                ...
                var logs = instance.end();
                sendQuick(logs);
                sended = true;
            };
        })();
        var beatUpload = function () {
            var logs = instance.beat();
            sendQuick(logs);
