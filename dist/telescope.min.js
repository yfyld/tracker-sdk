(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    function _wrapperData(data) {
        ...
        var config = getConfig();
        index++;
        return __assign(__assign(__assign(__assign({ data: data }, clientInfo()), libInfo), getUserInfo()), { projectId: config.projectId, version: config.version });
    }
    /**
     * 补充埋点信息
     * @param data
    ...
    function _generateData(data, config) {
        ...
        var resutl = __assign(__assign(__assign({}, data), getPageInfo()), { trackTime: Date.now(), id: uuid + '-' + index });
        //单页面设置referrer
            ...
            var _loop_1 = function (target) {
                ...
                if (target.getAttribute('data-track') ||
                    ...
                    if (element.tagName === 'A' && element.href) {
                        //劫持a链接注入本页面的code
                        var pageCode = getPageInfo().pageCode;
