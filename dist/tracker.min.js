(function (global, factory) {
    ...
    (global = global || self, factory(global.tracker = {}));
    ...
    ***************************************************************************** */
    ...
    cloneableTags[errorTag$1] = cloneableTags[funcTag$3] =
    ...
    if (scriptDom) {
        ...
        if (newConfig) {
            config = __assign({}, config, JSON.parse(newConfig));
        }
    }
    function getConfig() {
        return config;
    ...
    function setUserInfo(info) {
        ...
        userInfo = __assign({}, userInfo, { identify: getCookie(config.identify || TRACKER_IDENTIFY) }, info);
    }
    ...
    var ActionTracker = /** @class */ (function () {
        ...
        ActionTracker.prototype.trackLink = function (linkDom, info) {
            ...
            var trackInfo = __assign({ href: linkDom.href || "", domId: linkDom.id, domClass: linkDom.className, domTag: linkDom.tagName, domContent: linkDom.textContent.substr(0, 20), domPath: getDomPath(linkDom) }, info);
        ...
        ActionTracker.prototype.trackDom = function (dom, info) {
            ...
            if (track && track.search(/^\{[\S\s]*\}$/) >= 0) {
                trackInfo = __assign({}, trackInfo, JSON.parse(track));
            }
            else {
                trackInfo.trackId = track || "";
            }
            if (info) {
                trackInfo = __assign({}, trackInfo, info);
            }
            this.trackEvent(trackInfo);
        };
