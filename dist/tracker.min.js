(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    function login(info) {
        userInfo = __assign({}, userInfo, info);
    }
    function logout() {
        userInfo = {};
    }
            ...
            return function (target, key, descriptor) {
                var value = function () {
                    ...
                    if (typeof fn === 'function') { //参数为高阶函数
                        ...
                        if (typeof fn === 'object') {
                            var data_1 = __assign({}, fn);
                            instance$2.track(data_1);
                        }
                ...
                //   }, descriptor);
                // }
                return set(descriptor, 'value', value);
            };
        }
    ...
    var before = curry(function (trackFn, fn) { return function () {
        var args = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            args[_i] = arguments[_i];
        }
    ...
    var after = curry(function (trackFn, fn) { return function () {
        var _this = this;
        var args = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            args[_i] = arguments[_i];
